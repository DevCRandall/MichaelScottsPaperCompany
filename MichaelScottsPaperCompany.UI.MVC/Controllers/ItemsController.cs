...
namespace MichaelScottsPaperCompany.UI.MVC.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ItemsController(MichaelScottsPaperCompanyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ItemId,ItemName,ItemPrice,ItemDescription,ItemsInStock,CategoryId,ManufacturerId,InStock,LastOrderedDate,ItemImage")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ItemId,ItemName,ItemPrice,ItemDescription,ItemsInStock,CategoryId,ManufacturerId,InStock,LastOrderedDate,ItemImage")] Item item)
        {
            if (id != item.ItemId)
            {
                return NotFound();
